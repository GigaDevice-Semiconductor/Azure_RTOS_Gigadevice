...
/** NetX Component                                                        */
/**                                                                       */
/**   Ethernet driver for GD family of microprocessors             */
/**                                                                       */
/**************************************************************************/
/**************************************************************************/
...
#define NX_DRIVER_TX_DESCRIPTORS   16
...
typedef struct NX_DRIVER_INFORMATION_STRUCT
{
    ...
    UCHAR               nx_driver_information_dma_rx_descriptors_area[sizeof(enet_descriptors_struct) * NX_DRIVER_RX_DESCRIPTORS + 16];
    UCHAR               nx_driver_information_dma_tx_descriptors_area[sizeof(enet_descriptors_struct) * NX_DRIVER_TX_DESCRIPTORS + 16];

    enet_descriptors_struct                *nx_driver_information_dma_rx_descriptors;
    enet_descriptors_struct                *nx_driver_information_dma_tx_descriptors;
