...
#define SAMPLE_IPV4_ADDRESS         IP_ADDRESS(192, 168, 62, 70)
...
#define SAMPLE_GATEWAY_ADDRESS      IP_ADDRESS(192, 168, 62, 1)
...
#define SAMPLE_DNS_SERVER_ADDRESS   IP_ADDRESS(192, 168, 60, 1)
